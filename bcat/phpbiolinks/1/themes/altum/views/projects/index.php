...
<section class="container">
    ...
    <div class="row mb-4">
        ...
        <div class="col-12 col-xl-auto d-flex">
            ...
            <?php if($this->user->plan_settings->projects_limit != -1 && $data->projects_total >= $this->user->plan_settings->projects_limit): ?>
                <button type="button" data-confirm="<?= language()->projects->error_message->projects_limit ?>"  class="btn btn-primary"><i class="fa fa-fw fa-plus-circle"></i> <?= language()->projects->create ?></button>
            <?php else: ?>
            ...
            <div class="ml-3">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right filters-dropdown">
                        <div class="dropdown-header d-flex justify-content-between px-2">
    ...
    <?php if(count($data->projects)): ?>
        ...
        <?php foreach($data->projects as $row): ?>
            <div class="custom-row my-4 border" data-project-id="<?= $row->project_id ?>">
                <div class="row">

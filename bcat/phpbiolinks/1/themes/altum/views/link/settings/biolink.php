    ...
    <div class="col-12 col-lg-6">
        ...
        <div class="d-flex justify-content-between">
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link rounded <?= !isset($_GET['tab']) || (isset($_GET['tab']) && $_GET['tab'] == 'settings') ? 'active' : null ?>" id="settings-tab" data-toggle="pill" href="#settings" role="tab" aria-controls="settings" aria-selected="true"><?= language()->link->header->settings_tab ?></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link rounded <?= isset($_GET['tab']) && $_GET['tab'] == 'links'? 'active' : null ?>" id="links-tab" data-toggle="pill" href="#biolink_blocks" role="tab" aria-controls="links" aria-selected="false"><?= language()->link->header->links_tab ?></a>
                </li>
            </ul>
                            ...
                            <div class="form-group">
                                <div class="m-1 d-flex flex-column align-items-center justify-content-center">
                                    <label aria-label="<?= language()->link->settings->image ?>" class="clickable">
                                        ...
                                        <input id="image_file_input" type="file" name="image" accept=".gif, .ico, .png, .jpg, .jpeg, .svg, .jfif" class="form-control-file" style="display:none;" />
                                ...
                                <div class="<?= $this->user->plan_settings->custom_backgrounds ? null : 'container-disabled' ?>">
                                    ...
                                    <div id="background_type_image">
                                        <div class="form-group">
                                            ...
                                            <?php endif ?>
                                            <input id="background_type_image_input" type="file" name="background" accept=".gif, .ico, .png, .jpg, .jpeg, .svg, .jfif" class="form-control-file" />
                                ...
                                <div <?= $this->user->plan_settings->seo ? null : 'data-toggle="tooltip" title="' . language()->global->info_message->plan_feature_no_access . '"' ?>>
                                    <div class="<?= $this->user->plan_settings->seo ? null : 'container-disabled' ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="seo_image" type="file" name="seo_image" accept=".gif, .png, .jpg, .jpeg, .jfif" class="form-control-file" />
            ...
            <div class="tab-pane fade <?= isset($_GET['tab']) && $_GET['tab'] == 'links'? 'show active' : null ?>" id="biolink_blocks" role="tabpanel" aria-labelledby="links-tab">
                ...
                <?php if($data->link_links_result->num_rows): ?>
                    ...
                    <?php $row->settings = json_decode($row->settings) ?>
                        ...
                        <div class="biolink_block card border <?= $row->is_enabled ? null : 'custom-row-inactive' ?> my-4" data-biolink-block-id="<?= $row->biolink_block_id ?>">
                            <div class="card-body px-2 px-md-3">

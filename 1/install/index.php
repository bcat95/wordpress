                ...
                <div class="d-flex flex-column justify-content-center">
                    ...
                    <p class="subheader d-flex flex-row">
                        <span class="text-muted">
                            <a href="<?= PRODUCT_URL ?>" target="_blank" class="text-gray-500"><?= PRODUCT_NAME ?></a> by <a href="https://altumco.de/site" target="_blank" class="text-gray-500">AltumCode, Nulled By BlakenFist</a>
                        </span>
                    </p>
                </div>
            </div>
                ...
                <section id="setup" style="display: none">
                    ...
                    <form id="setup_form" method="post" action="" role="form">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="license" name="license" aria-describedby="license_help" placeholder="Babiato.co" required="required">
                            <small id="license_help" class="form-text text-muted">The Site that You downloaded from.</small>
                        </div>
